...
function RedPandas() {
  return <>
    ...
    >
      <Box component="div" sx={{ width: "50%",display:{
        md:"block",
        xs:"none"
      } }} >
      ...
      <Box component="div" sx={{
        ...
        <Fade right cascade>
          <a style={{ textDecoration: "underline", textAlign: "justify", fontFamily: "'Balsamiq Sans', cursive", fontSize: '2.5rem', color: "#f87171" }} href="">"So far we have donated $50,000 with over $50,000 more to come"</a>
        </Fade>
        <Fade right cascade>
          <Typography
            variant="subtitle1"
